...
destination_file <- file.path("data", "demographics", "raw", "population.csv")
...
# Function to verify the presence of population.csv in data/demographics/raw/
verify_us_population <- function() {
  raw_dir <- file.path("data", "demographics", "raw")
  file_path <- file.path(raw_dir, "population.csv")
  
  if(file.exists(file_path)) {
    cat("Success: 'population.csv' exists in 'data/demographics/raw/'.\n")
  } else {
    cat("Error: 'population.csv' does NOT exist in 'data/demographics/raw/'.\n")
  }
}
